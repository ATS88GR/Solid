...
public class MediumHotDog implements HotDog{
    private final double BREAD = 1.0;
    private final double SAUSAGE = 1.0;
    private final double ONION = 0.02;
    private final double MAYONNAISE = 0.15;
    private final double MUSTARD = 0.02;
    private final double KETCHUP = 0.02;
